 ...
 */
class DirectPathJSLoadSink implements AutoCloseable, ConsumerWithError<List<SeparatedString>, SQLException> {
    ...
    public DirectPathJSLoadSink(JSWrapper parameters) throws SQLException {
