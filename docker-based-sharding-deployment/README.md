...
In case, you want to manually create the docker/podman network and deploy the containers for the sharded database manually, please refer to the below sections for the step by step procedure.
