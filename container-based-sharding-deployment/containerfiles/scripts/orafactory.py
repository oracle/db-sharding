...
class OraFactory:
    ...
    def get_ora_objs(self):
        ...
        if self.ora_env_dict["OP_TYPE"] in ['primaryshard','setuprac,primaryshard','primaryshard,setuprac']:
        ...
        elif self.ora_env_dict["OP_TYPE"] in ['standbyshard','setuprac,standbyshard','standbyshard,setuprac']:
        ...
        elif self.ora_env_dict["OP_TYPE"] in ['catalog','setuprac,catalog','catalog,setuprac']:
