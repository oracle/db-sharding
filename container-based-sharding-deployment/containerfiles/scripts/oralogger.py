...
class OraLogger(object):
   ...
   def __init__(self, filename_):
      ...
      self.stdoutfile_ = "/tmp/test_shard.log" if os.environ.get("CRS_GPC") == "true" or os.environ.get("CRS_RACDB") == "true" else "/proc/1/fd/1"
...
class CHandler(Handler):
   ...
   #         ch = logging.StreamHandler()
            ch = logging.FileHandler("/tmp/sharding_setup.log") 
